...
export const LOADING_OBSERVER = "LOADING_OBSERVER";
export const LOADING_OBSERVER_SUCCESS = "LOADING_OBSERVER_SUCCESS";
export const LOADING_OBSERVER_FAIL = "LOADING_OBSERVER_FAIL";
